# PROJECT_CONTEXT.md — kitt_gateway

## Purpose
Gateway/orchestrator environment.
...
- PROJECT_INDEX.md
- STATUS.md     ← Source of truth for current status and risks
- NEXT.md
- LINKS.md

## Current Status
See: ~/builder-os/01-projects/kitt_gateway/STATUS.md
