...
| `join_token` | `6087b957-918f-4eed-a0da-813dcf887f10` | `spire/agent/agent.conf` ⚠️ rotate |
...
- **SPIRE join token** (`6087b957-918f-4eed-a0da-813dcf887f10`) is stored in plaintext in `spire/agent/agent.conf`. Rotate after first attestation. (I7 — open)
